...
namespace utf
{
    ...
    namespace detail {
        ...
        struct onerror_handler< utf8_to_utf32_iterator<Ts...>, replace_with<value>, void>
        {
        ...
        template <typename... Ts>
        struct onerror_handler< utf8_to_utf32_iterator<Ts...>, throw_exception, void>
        {
            static uint32_t apply(const std::string& errmsg) { throw std::runtime_error(errmsg); }

        };

        template<typename endianness, typename... Ts>
        struct to_handler < utf8_to_utf32_iterator<Ts...>, endianness>
        {
...
namespace utf
{
    ...
    namespace detail {
        ...
        template<uint32_t value, typename... Ts>
        struct onerror_handler< utf32_to_utf8_iterator<Ts...>, replace_with<value>, void>
        {
        ...
        template <typename... Ts>
        struct onerror_handler< utf32_to_utf8_iterator<Ts...>, throw_exception, void>
        {
            static uint32_t apply(const std::string& errmsg, uint32_t& codepoint) {
        ...
        template<typename endianness, typename... Ts>
        struct from_handler < utf32_to_utf8_iterator<Ts...>, endianness>
        {
            static uint32_t apply(uint32_t codepoint) {
...
namespace utf
{
    ...
    namespace detail {
        ...
        template<uint32_t value, typename... Ts>
        struct onerror_handler< utf16_to_utf32_iterator<Ts...>, replace_with<value>, void>
        {
            static uint32_t apply(const std::string& errmsg) {
                return value;
            }
        ...
        template <typename... Ts>
        struct onerror_handler< utf16_to_utf32_iterator<Ts...>, throw_exception, void>
        {
            static uint32_t apply(const std::string& errmsg) { throw std::runtime_error(errmsg); }
        ...
        template<typename endianness, typename... Ts>
        struct to_handler < utf16_to_utf32_iterator<Ts...>, endianness>
        {
            static uint32_t apply(uint32_t codepoint) {
                return codepoint_as<endianness>(codepoint);
            }
        ...
        template<typename endianness, typename... Ts>
        struct from_handler < utf16_to_utf32_iterator<Ts...>, endianness>
        {
...
namespace utf
{
    ...
    namespace detail {
        ...
        template<uint32_t value, typename... Ts>
        struct onerror_handler< utf32_to_utf16_iterator<Ts...>, replace_with<value>, void>
        {
            static uint32_t apply(const std::string& errmsg, uint32_t& codepoint) {
                return codepoint = value;
            }
        ...
        template <typename... Ts>
        struct onerror_handler< utf32_to_utf16_iterator<Ts...>, throw_exception, void>
        {
            static uint32_t apply(const std::string& errmsg, uint32_t& codepoint) {
                throw std::runtime_error(errmsg);
            }
        ...
        template<typename endianness, typename... Ts>
        struct to_handler < utf32_to_utf16_iterator<Ts...>, endianness>
        {
            static uint16_t apply(uint16_t codeunit) {
        ...
        template<typename endianness, typename... Ts>
        struct from_handler < utf32_to_utf16_iterator<Ts...>, endianness>
        {
            static uint32_t apply(uint32_t codepoint) {
                return codepoint_as<native_endian, endianness>(codepoint);
            }
